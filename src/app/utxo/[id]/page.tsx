      ...
      <div className="border-gray-200">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="mb-6">
            ...
            <p className="text-gray-600">Transaction output details and provenance information</p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="mt-1">
                    <span className={getStatusBadge(utxo.status)}>{utxo.status}</span>
                  </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mb-4">
                      ...
                      {vow.value !== undefined && (
                        <div>
                          ...
                          <div className="mt-1 font-mono text-sm">{vow.value.toFixed(8)} BTC</div>
                        </div>
                      )}
          ...
          <div className="qproof-card">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button onClick={handleDownloadJSON} className="qproof-btn qproof-btn-secondary">
                Download JSON
              </button>
