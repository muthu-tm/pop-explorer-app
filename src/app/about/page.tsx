      ...
      <div className="qproof-card">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-3 mb-4">
            <img src="/qproof_logo.png" alt="QProof Logo" className="w-12 h-12" />
            <h1 className="text-4xl font-bold text-gray-900">QProof Explorer</h1>
          </div>
          <p className="text-xl text-gray-600">Verifiable Bitcoin Provenance, Made Simple</p>
        </div>
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              QProof Explorer is an external service designed to make it easy to track QProof
              provenance for Bitcoin transactions. It provides a clear view of how transaction
              outputs (UTXOs) and public keys are registered, verified, and finalized across blocks.
            </p>
            <p className="text-gray-700 mb-4">With QProof Explorer, you can:</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              The QProof protocol ensures that every transaction is backed by a verifiable chain of
              cryptographic evidence. This strengthens trust in Bitcoin transactions by making their
              legitimacy transparent and auditable.
            </p>
            <p className="text-gray-700 mb-4">
              QProof Explorer serves as the public window into that process. Whether you are a
              wallet user, developer, or auditor, the explorer makes it simple to validate:
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-6">
              The protocol uses quantum-resistant cryptography to double-sign Bitcoin transactions.
              This means every action is bound both by Bitcoin&apos;s proof-of-work consensus and by
              QProof&apos;s cryptographic ledger.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#f9fafc] p-6 rounded-lg shadow-sm">
                <div className="text-[#00CA65] text-4xl font-bold mb-3">01</div>
                <p className="text-gray-700">Wallets generate microproofs and final proofs.</p>
              </div>
              <div className="bg-[#f9fafc] p-6 rounded-lg shadow-sm">
                <div className="text-[#00CA65] text-4xl font-bold mb-3">02</div>
                <p className="text-gray-700">
                  Servers verify that the keys and UTXOs were registered at least one block before
                  they are used.
                </p>
              </div>
              <div className="bg-[#f9fafc] p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">
                  QProof Explorer displays these records and lets anyone independently check
                  provenance and inclusion proofs.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#f9fafc] p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">
                  Watch inclusions being added to the current block in real-time as they are
              ...
              <div className="bg-[#f9fafc] p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">
                  Search by UTXO ID, public key, or block number to dive deep into specific
                  transaction details.
                </p>
              </div>
              <div className="bg-[#f9fafc] p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">
                  Access complete Merkle proofs and verify the cryptographic integrity of any
                  inclusion.
                </p>
              </div>
              <div className="bg-[#f9fafc] p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">
                  Trace the complete history of UTXOs and keys from their first registration to
                  current status.
                </p>
              </div>
            </div>
          ...
          <section className="mb-8">
            <div className="bg-[#f9fafc] p-6 text-center md:p-8 rounded-lg shadow-sm mx-auto">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">⚡ QProof Explorer</h2>
