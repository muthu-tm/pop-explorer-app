    ...
    <div className={`flex items-center justify-between flex-col sm:flex-row ${className}`}>
      <div className="flex items-center space-x-2">
        <button
          ...
          className="px-3 py-2 text-[0.5rem] sm:text-sm font-medium text-[#00CA65] bg-[#ebfff5] border border-[#00CA65] rounded-md hover:bg-[#ebfff5] disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Previous
        </button>
